package com.ying.bible.niv.grabber;
 ...
 * 
 */
public class NivBibleBook {
	//this is the html file going to be generated.
	private static String bookFileName = "nivbibleEn.html";
	
	private String[] links = null;
	
	private String prefix = "<table cellspacing=3 width=100%>";
	private String prefixreplace = "<table class=c cellspacing=3 width=100%>";
	
	private String suffix = "<tr><td valign=top>&nbsp;";
	...
	public NivBibleBook(int bookIndex) {
		String linkTemplate = "http://bible.kuanye.net/niv/B%sC%s.htm";
	...
	/*
	 * This is to help building the links to grab, because chapter number in the url can be padding "0" to the front.  
	 */
